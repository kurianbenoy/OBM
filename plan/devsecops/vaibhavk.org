...
* PLAN 
** vaibhavk
*** [#A] Kapitan: [[https://github.com/deepmind/kapitan/issues/201][GSoC task #201 - II]]
    :PROPERTIES:
    :ESTIMATED: 5
    :ACTUAL:
    :OWNER:    vaibhavk
    ...
    :END:
*** [#B] Taskcluster: [[https://bugzilla.mozilla.org/show_bug.cgi?id=1533591][Adjust auth API]]
    :PROPERTIES:
    :ESTIMATED: 8
    :ACTUAL:
    :OWNER: vaibhavk
