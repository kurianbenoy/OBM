...
|---------------+-----------+--------+------+-----------+--------------+------------|
| Jasonbraganza |      26.0 |    4.7 |    0 |      26.0 |   2018-10-01 | ---------- |
#+END:
** BURNDOWN CHART
...
| TASKS                               |                  |               | B        |             |      26.0 |    4.7 |
|-------------------------------------+------------------+---------------+----------+-------------+-----------+--------|
| Learn to use Dvorak keyboard layout | WRITE.1536571387 | jasonbraganza | B        | IN_PROGRESS |      13.0 |   2.50 |
|-------------------------------------+------------------+---------------+----------+-------------+-----------+--------|
| Learn GNU Emacs                     | READ.1536571485  | jasonbraganza | B        | IN_PROGRESS |      13.0 |   2.20 |
#+END:
* TASKS
  :PROPERTIES:
  :ID:       TASKS
  ...
  :wpd-jasonbraganza: 2
  :END:
** IN_PROGRESS Learn to use Dvorak keyboard layout [4/14]
   :PROPERTIES:
   :ESTIMATED: 13.0
   :ACTUAL:   2.50
   :OWNER: jasonbraganza
...
** IN_PROGRESS Learn GNU Emacs [3/14]
   :PROPERTIES:
   :ESTIMATED: 13.0
   :ACTUAL:   2.20
   :OWNER: jasonbraganza
