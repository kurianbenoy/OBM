...
|---------------+-----------+--------+------+-----------+--------------+------------|
| Jasonbraganza |      13.0 |    1.0 |    0 |      13.0 |   2018-09-21 | ---------- |
#+END:
** BURNDOWN CHART
...
| TASKS                               |                  |               | B        |             |      26.0 |    2.0 |
|-------------------------------------+------------------+---------------+----------+-------------+-----------+--------|
| Learn to use Dvorak keyboard layout | WRITE.1536571387 | jasonbraganza | B        | IN_PROGRESS |      13.0 |   1.00 |
|-------------------------------------+------------------+---------------+----------+-------------+-----------+--------|
| Learn GNU Emacs                     | READ.1536571485  | shaks         | B        | IN_PROGRESS |      13.0 |   1.00 |
#+END:
* TASKS
  :PROPERTIES:
  :ID:       TASKS
  ...
  :wpd-jasonbraganza: 2
  :END:
** IN_PROGRESS Learn to use Dvorak keyboard layout [1/14]
   :PROPERTIES:
   :ESTIMATED: 13.0
   :ACTUAL:   1.00
   :OWNER: jasonbraganza
...
** IN_PROGRESS Learn GNU Emacs [2/14]
   :PROPERTIES:
   :ESTIMATED: 13.0
   :ACTUAL:   1.00
   :OWNER: shaks
   ...
   :END:
   :LOGBOOK:
   CLOCK: [2018-09-11 Tue 15:20]--[2018-09-11 Tue 16:00]
   CLOCK: [2018-09-11 Tue 15:00]--[2018-09-11 Tue 15:20]
   :END:
   - [X] 1. Emacs Basics
   - [X] 2. Editing
